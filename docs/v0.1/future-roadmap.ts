...
export type TagTaxonomy = { tags: Tag[] };
 ...
 */
export type ExcerptWithRefs = ExcerptV2 & { refs?: ExcerptRefs };
...
export type VerseToTafsirIndex = { [verse: string]: TafsirReference[] };
...
const exampleVerseTafsir: VerseToTafsirIndex = {
    ...
    '2:255': [{ book: 3001, excerpts: ['3001:5432', '3001:5433'] }],
};
...
export type NarratorProfilesIndex = { [slug: string]: NarratorProfile };
...
export type ExcerptWithTranslations = Omit<ExcerptWithRefs, 'text' | 'translator'> & { translations: Translation[] };
...
const exampleCommentary: ExcerptWithCommentary = {
    ...
    footnotes: [{ ref: '1', text: 'Ar-Rahman: The Most Merciful in essence', type: 'translator' }],
};
...
export type SearchIndex = { terms: { [term: string]: SearchResult[] } };
...
export type ChunkedContentManifest = { chunked: true; chunkBy: 'volume' | 'page' | 'section'; chunks: ChunkInfo[] };
