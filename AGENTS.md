...
- When network access is available, refresh dependencies with `bun update --latest` so the app stays on Next.js 15.5, React 19, Tailwind CSS 4.1, TypeScript 5.9, and Biome 2.2.
